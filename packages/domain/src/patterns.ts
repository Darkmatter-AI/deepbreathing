/**
 * Breathing pattern catalog — the single canonical copy. Web, mobile and the
 * retired native re-implementation all re-export from here; edit patterns,
 * timings and descriptions in this file only.
 *
 * Descriptions match the live site copy (the strings that were crawled and
 * translated for the i18n catalogs).
 */

import { ModeName } from "./modes";
import type { BreathingPattern } from "./pacing";

/** Protocol phases (multi-round techniques like Wim Hof). */
