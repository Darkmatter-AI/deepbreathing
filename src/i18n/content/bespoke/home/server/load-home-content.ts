...
export type HomeContentLocale = "de-de" | "es-es" | "fr-fr" | "ja-jp" | "pt-br" | "it-it";
...
type Coverage = {
  ...
  locales: Record<HomeContentLocale, {
    publishable: boolean;
...
export async function loadHomeContent(
  ...
  if (
    ...
    throw new Error(`Native i18n home content is incomplete for ${locale}; refusing English fallback`);
  }

  return contentLoaders[locale]() as Promise<HomePageContent>;
}
