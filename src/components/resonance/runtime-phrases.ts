import type { ModeName } from '@resonance/audio';
...
const EN: LocaleTable = {
  ...
  'ui.beta_waves': 'Beta Waves ({n}Hz)',
  'ui.alertness': 'Alertness',
  'ui.delta_waves': 'Delta Waves ({n}Hz)',
  'ui.deep_sleep': 'Deep Sleep',
  'ui.pink_noise_rain': 'Pink Noise (Rain)',
  ...
  'auth.one_tap_no_password': 'One tap. No password.',
...
const ES: LocaleTable = {
  ...
  'instruction.hold_your_breath': 'Aguanta la respiración...',
  ...
  'phase.inhale': 'Inhala',
  'phase.exhale': 'Exhala',
  'protocol.power_breathe': 'Respiración intensa',
  'protocol.round_complete': 'Ronda {round} completada',
  'protocol.complete': '¡Protocolo completado!',
  'ui.power_breath': 'Respiración intensa',
  'ui.round_of': 'Ronda {current} de {total}',
  'ui.breath_of': 'Respiración {current} de {total}',
  'ui.end_hold_recovery': 'Terminar pausa → Respiración de recuperación',
  'ui.sound_hint_no_audio': 'Si no escuchas ningún sonido, asegúrate de que tu teléfono no esté en modo silencioso.',
  'ui.duration_sec': '{n}s',
  'ui.duration_min': '{n} min',
  'ui.settings': 'Ajustes',
  'ui.sound_off': 'Sonido apagado',
  'ui.sound_on': 'Sonido encendido',
  'ui.session_length': 'Duración de la sesión',
  'ui.open': 'Sin límite',
  'ui.pause_to_change': 'Pausa para cambiar la duración de la sesión.',
  'ui.pause_session_to_switch': 'Pausa la sesión para cambiar de modo, ajustar el ritmo o la duración.',
  ...
  'ui.rounds': 'Rondas',
  'ui.breaths': 'Respiraciones',
  'ui.duration': 'Duración',
  'ui.beta_waves': 'Ondas beta ({n} Hz)',
  'ui.alertness': 'Alerta',
  'ui.delta_waves': 'Ondas delta ({n} Hz)',
  'ui.deep_sleep': 'Sueño profundo',
  'ui.pink_noise_rain': 'Ruido rosa (lluvia)',
  ...
  'auth.sync_subtitle': 'Sincroniza tus sesiones de respiración y ajustes entre dispositivos.',
  'auth.save_and_sync': 'Guarda tu progreso y sincroniza entre dispositivos.',
  'auth.nice_session': 'Buena sesión',
  'auth.minutes_of_calm': '{n} minutos de calma',
  'auth.total_minutes': '{n} min',
  'auth.of_breathing_logged': 'de respiración registrados',
  'auth.continue_google': 'Continuar con Google',
  'auth.one_tap_no_password': 'Un toque. Sin contraseña.',
  ...
  'auth.something_went_wrong': 'Algo salió mal. Inténtalo de nuevo.'
};

const FR: LocaleTable = {
  'session.ready_to_start': 'Prêt à commencer ?',
  ...
  'instruction.exhale_fully': 'Expirez complètement...',
  ...
  'protocol.round_complete': 'Cycle {round} terminé',
  'protocol.complete': 'Protocole terminé !',
  'ui.power_breath': 'Respiration puissante',
  'ui.round_of': 'Cycle {current} sur {total}',
  'ui.breath_of': 'Souffle {current} sur {total}',
  'ui.end_hold_recovery': 'Fin de rétention → Souffle de récupération',
  'ui.sound_hint_no_audio': 'Si vous n’entendez aucun son, vérifiez que votre téléphone n’est pas en mode silencieux.',
  'ui.duration_sec': '{n}s',
  'ui.duration_min': '{n} min',
  'ui.settings': 'Paramètres',
  'ui.sound_off': 'Son coupé',
  'ui.sound_on': 'Son activé',
  'ui.session_length': 'Durée de la session',
  'ui.open': 'Sans limite',
  'ui.pause_to_change': 'Mettez en pause pour changer la durée de la session.',
  'ui.pause_session_to_switch': 'Mettez la session en pause pour changer de mode, ajuster le rythme ou la durée.',
  ...
  'ui.audio_8d': 'Audio 8D',
  'ui.rounds': 'Cycles',
  'ui.breaths': 'Respirations',
  'ui.duration': 'Durée',
  'ui.beta_waves': 'Ondes bêta ({n} Hz)',
  'ui.alertness': 'Vigilance',
  'ui.delta_waves': 'Ondes delta ({n} Hz)',
  'ui.deep_sleep': 'Sommeil profond',
  'ui.pink_noise_rain': 'Bruit rose (pluie)',
  ...
  'ui.match_system_default': 'Suivre le système',
  'ui.dismiss': 'Fermer',
  'ui.close': 'Fermer',
  'ui.link': 'Lien',
  'ui.copy': 'Copier',
  ...
  'auth.sync_subtitle': 'Synchronisez vos sessions de respiration et vos réglages sur tous vos appareils.',
  ...
  'auth.total_minutes': '{n} min',
  'auth.of_breathing_logged': 'de respiration enregistrées',
  'auth.continue_google': 'Continuer avec Google',
  'auth.one_tap_no_password': 'Un geste. Aucun mot de passe.',
  ...
  'auth.sent_link_to': 'Nous avons envoyé un lien de connexion à',
  'auth.something_went_wrong': 'Une erreur s’est produite. Veuillez réessayer.'
};
...
const DE: LocaleTable = {
  ...
  'instruction.exhale_fully': 'Vollständig ausatmen...',
  ...
  'ui.sound_hint_no_audio': 'Wenn du keinen Ton hörst, stelle sicher, dass dein Telefon nicht stummgeschaltet ist.',
  'ui.duration_sec': '{n} s',
  'ui.duration_min': '{n} Min.',
  ...
  'ui.open': 'Ohne Limit',
  'ui.pause_to_change': 'Pausiere, um die Sitzungsdauer zu ändern.',
  'ui.pause_session_to_switch': 'Pausiere die Sitzung, um den Modus, das Tempo oder die Dauer zu ändern.',
  ...
  'ui.breaths': 'Atemzüge',
  'ui.duration': 'Dauer',
  'ui.beta_waves': 'Betawellen ({n} Hz)',
  'ui.alertness': 'Wachheit',
  'ui.delta_waves': 'Deltawellen ({n} Hz)',
  'ui.deep_sleep': 'Tiefer Schlaf',
  'ui.pink_noise_rain': 'Rosa Rauschen (Regen)',
  ...
  'auth.sync_subtitle': 'Synchronisiere deine Atemsitzungen und Einstellungen auf allen Geräten.',
  'auth.save_and_sync': 'Speichere deinen Fortschritt und synchronisiere ihn auf allen Geräten.',
  ...
  'auth.one_tap_no_password': 'Ein Tipp. Kein Passwort.',
  ...
  'auth.check_email': 'E-Mail prüfen',
  'auth.sent_link_to': 'Wir haben einen Anmeldelink an',
  'auth.something_went_wrong': 'Etwas ist schiefgelaufen. Bitte erneut versuchen.'
};

const PT: LocaleTable = {
  'session.ready_to_start': 'Pronto para começar?',
  ...
  'instruction.hold_your_breath': 'Prenda a respiração...',
  ...
  'phase.exhale': 'Expire',
  'protocol.power_breathe': 'Respiração intensa',
  'protocol.round_complete': 'Rodada {round} concluída',
  'protocol.complete': 'Protocolo concluído!',
  'ui.power_breath': 'Respiração intensa',
  'ui.round_of': 'Rodada {current} de {total}',
  'ui.breath_of': 'Respiração {current} de {total}',
  'ui.end_hold_recovery': 'Encerrar pausa → Respiração de recuperação',
  'ui.sound_hint_no_audio': 'Se você não ouvir som, confira se o telefone não está no modo silencioso.',
  'ui.duration_sec': '{n}s',
  'ui.duration_min': '{n} min',
  'ui.settings': 'Configurações',
  'ui.sound_off': 'Som desligado',
  'ui.sound_on': 'Som ligado',
  'ui.session_length': 'Duração da sessão',
  'ui.open': 'Sem limite',
  'ui.pause_to_change': 'Pause para alterar a duração da sessão.',
  'ui.pause_session_to_switch': 'Pause a sessão para trocar de modo, ajustar o ritmo ou a duração.',
  ...
  'ui.rounds': 'Rodadas',
  'ui.breaths': 'Respirações',
  'ui.duration': 'Duração',
  'ui.beta_waves': 'Ondas beta ({n} Hz)',
  'ui.alertness': 'Atenção',
  'ui.delta_waves': 'Ondas delta ({n} Hz)',
  'ui.deep_sleep': 'Sono profundo',
  'ui.pink_noise_rain': 'Ruído rosa (chuva)',
  ...
  'ui.sign_out': 'Sair',
  'ui.match_system_default': 'Usar preferência do sistema',
  ...
  'auth.sync_subtitle': 'Sincronize suas sessões de respiração e configurações entre dispositivos.',
  'auth.save_and_sync': 'Salve seu progresso e sincronize entre dispositivos.',
  'auth.nice_session': 'Boa sessão',
  'auth.minutes_of_calm': '{n} minutos de calma',
  'auth.total_minutes': '{n} min',
  'auth.of_breathing_logged': 'de respiração registrados',
  'auth.continue_google': 'Continuar com Google',
  'auth.one_tap_no_password': 'Um toque. Sem senha.',
...
const JA: LocaleTable = {
  ...
  'session.paused': '一時停止',
  'session.tap_enable_sound': '一度タップして音を有効にする',
  ...
  'ui.breaths': '呼吸',
  'ui.duration': '所要時間',
  'ui.beta_waves': 'ベータ波（{n}Hz）',
  'ui.alertness': '覚醒',
  'ui.delta_waves': 'デルタ波（{n}Hz）',
  'ui.deep_sleep': '深い眠り',
  'ui.pink_noise_rain': 'ピンクノイズ（雨）',
  ...
  'auth.one_tap_no_password': 'ワンタップ。パスワード不要。',
...
const IT: LocaleTable = {
  'session.ready_to_start': 'Pronto per iniziare?',
  'session.paused': 'In pausa',
  'session.tap_enable_sound': 'Tocca una volta per attivare l’audio',
  'session.complete': 'Sessione completata',
  'instruction.inhale_slowly': 'Inspira lentamente...',
  'instruction.inhale_again': 'Inspira di nuovo...',
  'instruction.exhale': 'Espira...',
  'instruction.exhale_fully': 'Espira completamente...',
  'instruction.inhale': 'Inspira...',
  'instruction.hold_your_breath': 'Trattieni il respiro...',
  'instruction.deep_breath_in': 'Fai un respiro profondo',
  'instruction.hold': 'Trattieni',
  'phase.ready': 'Pronto',
  'phase.hold': 'Trattieni',
  'phase.inhale_again': 'Inspira di nuovo',
  'phase.inhale': 'Inspira',
  'phase.exhale': 'Espira',
  'protocol.power_breathe': 'Respirazione intensa',
  'protocol.round_complete': 'Round {round} completato',
  'protocol.complete': 'Protocollo completato!',
  'ui.power_breath': 'Respirazione intensa',
  'ui.round_of': 'Round {current} di {total}',
  'ui.breath_of': 'Respiro {current} di {total}',
  'ui.end_hold_recovery': 'Termina il trattenimento → Respiro di recupero',
  'ui.sound_hint_no_audio': 'Se non senti alcun suono, assicurati che il telefono non sia in modalità silenziosa.',
  'ui.duration_sec': '{n} s',
  'ui.duration_min': '{n} min',
  'ui.settings': 'Impostazioni',
  'ui.sound_off': 'Audio disattivato',
  'ui.sound_on': 'Audio attivato',
  'ui.session_length': 'Durata della sessione',
  'ui.open': 'Senza limite',
  'ui.pause_to_change': 'Metti in pausa per cambiare la durata della sessione.',
  'ui.pause_session_to_switch': 'Metti in pausa la sessione per cambiare modalità, regolare il ritmo o modificare la durata.',
  'ui.binaural_beats': 'Battiti binaurali',
  'ui.alpha_waves': 'Onde alfa (10 Hz)',
  'ui.flow_state': 'Stato di flusso',
  'ui.drone_synth': 'Sintetizzatore drone',
  'ui.audio_8d': 'Audio 8D',
  'ui.rounds': 'Round',
  'ui.breaths': 'Respiri',
  'ui.duration': 'Durata',
  'ui.beta_waves': 'Onde beta ({n} Hz)',
  'ui.alertness': 'Vigilanza',
  'ui.delta_waves': 'Onde delta ({n} Hz)',
  'ui.deep_sleep': 'Sonno profondo',
  'ui.pink_noise_rain': 'Rumore rosa (pioggia)',
  'ui.account_menu': 'Menu dell’account',
  'ui.account': 'Account',
  'ui.your_practice': 'La tua pratica',
  'ui.delete_account_confirm': 'Eliminare definitivamente il tuo account e tutti i dati di pratica sincronizzati? Questa azione non può essere annullata.',
  'ui.delete_account_start_error': 'Non è stato possibile avviare l’eliminazione dell’account.',
  'ui.delete_account_check_email': 'Controlla la tua e-mail per confermare l’eliminazione permanente dell’account.',
  'ui.delete_account': 'Elimina account',
  'ui.settings_description': 'Regola modalità, ritmo e personalizzazione.',
  'ui.session': 'Sessione',
  'ui.on': 'Attivato',
  'ui.off': 'Disattivato',
  'ui.binaural_help': 'Funziona meglio con le cuffie. Gli altoparlanti mescolano i due canali nell’aria, annullando il battito binaurale.',
  'ui.appearance': 'Aspetto',
  'ui.auto_dark': 'Automatico (scuro)',
  'ui.auto_light': 'Automatico (chiaro)',
  'ui.dark': 'Scuro',
  'ui.light': 'Chiaro',
  'ui.following_device': 'Usa le preferenze del dispositivo.',
  'ui.pattern': 'Schema',
  'ui.speed': 'Velocità',
  'ui.speed_multiplier': '{n}×',
  'ui.seconds_per_phase': '{n} s per fase',
  'ui.breath_speed': 'Velocità della respirazione',
  'ui.ai_suggestion': 'Suggerimento dell’IA',
  'ui.pause_session': 'Metti in pausa la sessione',
  'ui.start_session': 'Avvia la sessione',
  'ui.sign_up': 'Registrati',
  'ui.sign_out': 'Esci',
  'ui.match_system_default': 'Usa le impostazioni predefinite del sistema',
  'ui.dismiss': 'Ignora',
  'ui.close': 'Chiudi',
  'ui.link': 'Link',
  'ui.copy': 'Copia',
  'ui.copied': 'Copiato',
  'ui.embed_on_site': 'Incorpora nel tuo sito',
  'ui.copy_snippet': 'Copia il codice',
  'ui.browse_embeds': 'Vedi tutti i contenuti incorporati →',
  'ui.change_language': 'Cambia lingua',
  'auth.create_free_account': 'Crea un account gratuito',
  'auth.save_progress': 'Salva i tuoi progressi',
  'auth.save_settings': 'Salva le impostazioni su tutti i dispositivi',
  'auth.sign_in_to_save': 'Accedi per salvare',
  'auth.save_progress_question': 'Vuoi salvare i tuoi progressi?',
  'auth.sync_subtitle': 'Sincronizza le sessioni di respirazione e le impostazioni tra i dispositivi.',
  'auth.save_and_sync': 'Salva i progressi e sincronizzali tra i dispositivi.',
  'auth.nice_session': 'Bella sessione',
  'auth.minutes_of_calm': '{n} minuti di calma',
  'auth.total_minutes': '{n} min',
  'auth.of_breathing_logged': 'di respirazione registrati',
  'auth.continue_google': 'Continua con Google',
  'auth.one_tap_no_password': 'Un tocco. Nessuna password.',
  'auth.continue_apple': 'Continua con Apple',
  'auth.or': 'oppure',
  'auth.you': 'te',
  'auth.just_now': 'proprio ora',
  'auth.sessions_keep': 'Hai completato {n} sessioni di calma. Vuoi conservarle?',
  'auth.streak_keep': 'Hai una serie di {n} giorni. Vuoi mantenerla?',
  'auth.session_count': '{n} sessione',
  'auth.sessions_count': '{n} sessioni',
  'auth.local_only': 'I tuoi progressi vengono conservati solo su questo dispositivo. Con un account gratuito puoi accedervi da qualsiasi dispositivo.',
  'auth.email_address': 'Indirizzo e-mail',
  'auth.send_link': 'Invia link',
  'auth.save_with_email': 'oppure salva con l’e-mail',
  'auth.enter_email': 'Inserisci la tua e-mail',
  'auth.send_magic_link': 'Invia link di accesso',
  'auth.sending_link': 'Invio del link...',
  'auth.not_now': 'Non ora',
  'auth.check_email': 'Controlla la tua e-mail',
  'auth.sent_link_to': 'Abbiamo inviato un link di accesso a',
  'auth.something_went_wrong': 'Si è verificato un problema. Riprova.'
};
...
const DEFAULT_MODE_LABELS: Record<ModeName, string> = {
  'Box Breathing': 'Box',
  '4-7-8 Relax': '4-7-8',
  'Coherent Breathing': 'Coherent',
  'Physiological Sigh': 'Sigh',
  'Wim Hof Breathing': 'Wim Hof',
  'Pursed Lip Breathing': 'Pursed',
  'Nadi Shodhana': 'Nadi',
  'Ujjayi Breathing': 'Ujjayi',
  'Belly Breathing': 'Belly',
  'Buteyko Breathing': 'Buteyko',
  'Tummo Breathing': 'Tummo',
  'Breath of Fire': 'Fire'
};

const ITALIAN_MODE_LABELS: Record<ModeName, string> = {
  'Box Breathing': 'Quadrata',
  '4-7-8 Relax': '4-7-8',
  'Coherent Breathing': 'Coerente',
  'Physiological Sigh': 'Sospiro',
  'Wim Hof Breathing': 'Wim Hof',
  'Pursed Lip Breathing': 'Labbra socchiuse',
  'Nadi Shodhana': 'Nadi',
  'Ujjayi Breathing': 'Ujjayi',
  'Belly Breathing': 'Diaframmatica',
  'Buteyko Breathing': 'Buteyko',
  'Tummo Breathing': 'Tummo',
  'Breath of Fire': 'Fuoco'
};

const MODE_LABELS: Readonly<Record<string, Record<ModeName, string>>> = {
  en: DEFAULT_MODE_LABELS,
  es: {
    'Box Breathing': 'Caja',
    '4-7-8 Relax': '4-7-8',
    'Coherent Breathing': 'Coherente',
    'Physiological Sigh': 'Suspiro',
    'Wim Hof Breathing': 'Wim Hof',
    'Pursed Lip Breathing': 'Labios fruncidos',
    'Nadi Shodhana': 'Nadi',
    'Ujjayi Breathing': 'Ujjayi',
    'Belly Breathing': 'Abdominal',
    'Buteyko Breathing': 'Buteyko',
    'Tummo Breathing': 'Tummo',
    'Breath of Fire': 'Fuego'
  },
  fr: {
    'Box Breathing': 'Carrée',
    '4-7-8 Relax': '4-7-8',
    'Coherent Breathing': 'Cohérente',
    'Physiological Sigh': 'Soupir',
    'Wim Hof Breathing': 'Wim Hof',
    'Pursed Lip Breathing': 'Lèvres pincées',
    'Nadi Shodhana': 'Nadi',
    'Ujjayi Breathing': 'Ujjayi',
    'Belly Breathing': 'Abdominale',
    'Buteyko Breathing': 'Buteyko',
    'Tummo Breathing': 'Tummo',
    'Breath of Fire': 'Feu'
  },
  de: {
    'Box Breathing': 'Box',
    '4-7-8 Relax': '4-7-8',
    'Coherent Breathing': 'Kohärent',
    'Physiological Sigh': 'Seufzer',
    'Wim Hof Breathing': 'Wim Hof',
    'Pursed Lip Breathing': 'Lippenbremse',
    'Nadi Shodhana': 'Nadi',
    'Ujjayi Breathing': 'Ujjayi',
    'Belly Breathing': 'Bauch',
    'Buteyko Breathing': 'Buteyko',
    'Tummo Breathing': 'Tummo',
    'Breath of Fire': 'Feuer'
  },
  pt: {
    ...
    'Physiological Sigh': 'Suspiro',
    'Wim Hof Breathing': 'Wim Hof',
    'Pursed Lip Breathing': 'Lábios semicerrados',
    'Nadi Shodhana': 'Nadi',
    'Ujjayi Breathing': 'Ujjayi',
    'Belly Breathing': 'Abdominal',
    'Buteyko Breathing': 'Buteyko',
  ...
  ja: {
    'Box Breathing': 'ボックス',
    '4-7-8 Relax': '4-7-8',
    'Coherent Breathing': 'コヒーレント',
    'Physiological Sigh': 'ため息',
    'Wim Hof Breathing': 'Wim Hof',
    'Pursed Lip Breathing': '口すぼめ',
    'Nadi Shodhana': 'Nadi',
    'Ujjayi Breathing': 'Ujjayi',
    'Belly Breathing': '腹式',
    'Buteyko Breathing': 'Buteyko',
...
/** Return the compact mode label used by the mode picker. */
export function resolveRuntimeModeLabel(locale: string, mode: ModeName): string {
  return (MODE_LABELS[normalizeLocale(locale)] ?? DEFAULT_MODE_LABELS)[mode];
}
