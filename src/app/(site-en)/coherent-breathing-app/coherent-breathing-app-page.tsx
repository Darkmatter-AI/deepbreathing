...
import type {
  CoherentBreathingAppMessageId,
  CoherentBreathingAppContent,
...
const sourceRoute = "/coherent-breathing-app";
const englishContent = sourceContent as CoherentBreathingAppContent;

export function createCoherentBreathingAppMetadataFromContent(
  content: CoherentBreathingAppContent,
...
export function CoherentBreathingAppPage({
  ...
  const copy = (messageId: CoherentBreathingAppMessageId) => content[messageId];
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: copy("schemaFaq.items.6.question"),
        acceptedAnswer: {
          "@type": "Answer",
          text: copy("schemaFaq.items.6.answer"),
        },
      },
    ],
  };
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <header className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">{copy("hero.updated")}</p>
      ...
      <section className="mt-10 grid gap-6 md:grid-cols-2">
        ...
        <div className="glow-card rounded-[32px] border border-border bg-card p-6">
          ...
          <div className="mt-5">
            <Link
              href={href("/breathe/coherent#how-to")}
      ...
      <section className="mt-12 space-y-6">
        <div className="glow-card rounded-[32px] border border-border bg-card p-8">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground">
            ...
            <p>{copy("definition.paragraphs.3")}</p>
          </div>
        </div>
          ...
          <div className="mt-4 space-y-4 text-muted-foreground">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex gap-3">
                ...
                <span>
                  <strong className="text-card-foreground">
                    {copy("benefits.items.6.label")}
                  </strong>
                  {wordGap}
                  {copy("benefits.items.6.body")}
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="glow-card rounded-[32px] border border-border bg-card p-8">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground">
            ...
            <p>{copy("mechanism.paragraphs.4")}</p>
            <p>{copy("mechanism.paragraphs.5")}</p>
          </div>
        </div>
          ...
          <div className="mt-4 space-y-4 text-muted-foreground">
            ...
            <ul className="space-y-3">
              <li className="flex gap-3">
                ...
                <span>
                  <strong className="text-card-foreground">
                    {copy("practice.items.0.label")}
                  </strong>
                  {wordGap}
                  {copy("practice.items.0.body")}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary">•</span>
                <span>
                  <strong className="text-card-foreground">
                    {copy("practice.items.1.label")}
                  </strong>
                  {wordGap}
                  {copy("practice.items.1.body")}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary">•</span>
                <span>
                  <strong className="text-card-foreground">
                    {copy("practice.items.2.label")}
                  </strong>
                  {wordGap}
                  {copy("practice.items.2.body")}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary">•</span>
                <span>
                  <strong className="text-card-foreground">
                    {copy("practice.items.3.label")}
                  </strong>
                  {wordGap}
                  {copy("practice.items.3.body")}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary">•</span>
                <span>
                  <strong className="text-card-foreground">
                    {copy("practice.items.4.label")}
                  </strong>
                  {wordGap}
                  {copy("practice.items.4.body")}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary">•</span>
                <span>
                  <strong className="text-card-foreground">
                    {copy("practice.items.5.label")}
                  </strong>
                  {wordGap}
                  {copy("practice.items.5.body")}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary">•</span>
                <span>
                  <strong className="text-card-foreground">
                    {copy("practice.items.6.label")}
                  </strong>
                  {wordGap}
                  {copy("practice.items.6.body")}
                </span>
              </li>
            </ul>
            <p className="mt-4">
              <strong className="text-card-foreground">
                {copy("practice.note.label")}
              </strong>
              {wordGap}
              {copy("practice.note.body")}
            </p>
          </div>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                <th className="py-3 text-left font-semibold text-card-foreground">
                  {copy("comparison.headers.technique")}
                </th>
                <th className="py-3 text-left font-semibold text-card-foreground">
                  {copy("comparison.headers.pattern")}
                </th>
                <th className="py-3 text-left font-semibold text-card-foreground">
                  {copy("comparison.headers.bestFor")}
                </th>
                <th className="py-3 text-left font-semibold text-card-foreground">
                  {copy("comparison.headers.duration")}
                </th>
              </tr>
            </thead>
            <tbody className="text-muted-foreground">
              <tr className="border-b border-border/50 bg-primary/5">
                <td className="py-3 font-medium text-card-foreground">
                  {copy("comparison.rows.0.technique")}
                </td>
                <td className="py-3">{copy("comparison.rows.0.pattern")}</td>
                <td className="py-3">{copy("comparison.rows.0.bestFor")}</td>
                <td className="py-3">{copy("comparison.rows.0.duration")}</td>
              </tr>
              <tr className="border-b border-border/50">
                <td className="py-3 font-medium text-card-foreground">
                  {copy("comparison.rows.1.technique")}
                </td>
                <td className="py-3">{copy("comparison.rows.1.pattern")}</td>
                <td className="py-3">{copy("comparison.rows.1.bestFor")}</td>
                <td className="py-3">{copy("comparison.rows.1.duration")}</td>
              </tr>
              <tr className="border-b border-border/50">
                <td className="py-3 font-medium text-card-foreground">
                  {copy("comparison.rows.2.technique")}
                </td>
                <td className="py-3">{copy("comparison.rows.2.pattern")}</td>
                <td className="py-3">{copy("comparison.rows.2.bestFor")}</td>
                <td className="py-3">{copy("comparison.rows.2.duration")}</td>
              </tr>
              <tr>
                <td className="py-3 font-medium text-card-foreground">
                  {copy("comparison.rows.3.technique")}
                </td>
                <td className="py-3">{copy("comparison.rows.3.pattern")}</td>
                <td className="py-3">{copy("comparison.rows.3.bestFor")}</td>
                <td className="py-3">{copy("comparison.rows.3.duration")}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="mt-12 space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Link
            href={href("/breathe/belly")}
            className="group glow-card rounded-[28px] border border-border bg-card p-5 transition hover:border-primary"
          >
            <p className="text-lg font-semibold text-card-foreground">
              {copy("related.cards.1.title")}
            </p>
            <p className="mt-1 text-sm text-muted-foreground">
              {copy("related.cards.1.body")}
            </p>
            <span className="mt-3 inline-flex items-center text-sm font-semibold text-primary">
              {copy("related.action")}
            </span>
          ...
          <Link
            href={href("/breathe/ujjayi")}
            className="group glow-card rounded-[28px] border border-border bg-card p-5 transition hover:border-primary"
          >
            <p className="text-lg font-semibold text-card-foreground">
              {copy("related.cards.2.title")}
            </p>
            <p className="mt-1 text-sm text-muted-foreground">
              {copy("related.cards.2.body")}
            </p>
            <span className="mt-3 inline-flex items-center text-sm font-semibold text-primary">
              {copy("related.action")}
            </span>
          ...
          <Link
            href={href("/breathe/buteyko")}
            className="group glow-card rounded-[28px] border border-border bg-card p-5 transition hover:border-primary"
          >
            <p className="text-lg font-semibold text-card-foreground">
              {copy("related.cards.3.title")}
            </p>
            <p className="mt-1 text-sm text-muted-foreground">
              {copy("related.cards.3.body")}
            </p>
            <span className="mt-3 inline-flex items-center text-sm font-semibold text-primary">
              {copy("related.action")}
            </span>
      ...
      <section className="mt-12 glow-card rounded-[32px] border border-border bg-card p-6">
        <h2 className="text-2xl font-semibold text-card-foreground">
          {copy("moreTools.title")}
        </h2>
        <p className="mt-2 text-sm text-muted-foreground">
          {copy("moreTools.intro")}
        </p>
        <div className="mt-5 flex flex-wrap gap-3">
          <Link
            ...
            className="rounded-full border border-border px-5 py-2.5 text-sm font-semibold text-card-foreground"
          >
            {copy("moreTools.links.0.label")}
          </Link>
          <Link
            href={href("/4-7-8-breathing-timer")}
            className="rounded-full border border-border px-5 py-2.5 text-sm font-semibold text-card-foreground"
          >
            {copy("moreTools.links.1.label")}
          </Link>
          <Link
            href={href("/2-minute-breathing-exercise")}
            className="rounded-full border border-border px-5 py-2.5 text-sm font-semibold text-card-foreground"
          >
            {copy("moreTools.links.2.label")}
          </Link>
          <Link
            href={href("/for/running")}
            className="rounded-full border border-border px-5 py-2.5 text-sm font-semibold text-card-foreground"
          >
            {copy("moreTools.links.3.label")}
          </Link>
          <Link
            href={href("/breathe")}
            className="rounded-full border border-border px-5 py-2.5 text-sm font-semibold text-card-foreground"
          >
            {copy("moreTools.links.4.label")}
          </Link>
        </div>
      </section>
